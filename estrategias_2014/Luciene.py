...
class MeuJogador(Jogador):
    ...
    def escolha_de_cacada(self, rodada, comida_atual, reputacao_atual, m, reputacoes_dos_jogadores):
        ...
        elif comida_atual<100:
            escolhas = ['d' for x in reputacoes_dos_jogadores  ] # modifique com a sua próprio estratégia
        else:
            escolhas = ['d' if x>=0.8 else 'c' for x in reputacoes_dos_jogadores  ] # modifique com a sua próprio estratégia
